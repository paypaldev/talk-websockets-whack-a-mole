...
export function EndScreen({
  ...
  return (
    <div className="flex flex-col items-center gap-5 bg-zinc-950/30 px-6 py-9 text-center">
      ...
      <div>
        <h2 className="mb-1 text-2xl font-semibold tracking-tight text-zinc-100">
          Time&apos;s Up
        </h2>
      ...
      <div
        ...
        style={{
          animation:
            "mole-appear 0.5s 0.1s cubic-bezier(0.34,1.56,0.64,1) both",
        }}
      >
        <span className="text-6xl font-semibold tabular-nums text-zinc-100">
          {score}
        </span>
      ...
      <div
        ...
        style={{
          animation:
            "mole-appear 0.5s 0.2s cubic-bezier(0.34,1.56,0.64,1) both",
        }}
      >
